...
const Translation=()=>{
    ...
    const [translationCheck,settranslationCheck] =useState(null)
...
<Box sx={{
        ...
        <TextField
          ...
          label="Translation"
          focused
          value={translationCheck}
          onChange={(e) =>
            settranslationCheck(e.target.value)} 
        />
</Box>
...
Random verb
        ...
        <Button variant="outlined" color="success" autoFocus onClick={checkTransaltion}>
              Check
        </Button> 
      ...
      <Alert severity="error">Incorrect! Correct answer: {translationVariable}</Alert>
      </Snackbar>
</Box>  
    )
}
